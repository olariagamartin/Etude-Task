...
public class MyItemTouchHelper extends RecyclerView.ItemDecoration
    ...
    public abstract static class Callback {
        ...
        /**
         * Returns the {@link MyItemTouchUIUtil} that is used by the {@link androidx.recyclerview.widget.ItemTouchHelper.Callback} class for
         * visual
         * changes on Views in response to user interactions. {@link MyItemTouchUIUtil} has different
         ...
         * </pre>
         *
         * @return The {@link MyItemTouchUIUtil} instance that is used by the {@link androidx.recyclerview.widget.ItemTouchHelper.Callback}
         */
        @SuppressWarnings("WeakerAccess")
        @NonNull
        public static ItemTouchUIUtilImpl getDefaultUIUtil() {
            return (ItemTouchUIUtilImpl) ItemTouchUIUtilImpl.INSTANCE;
        }
    ...
    public interface MyItemTouchUIUtil {
...
class ItemTouchUIUtilImpl implements MyItemTouchHelper.MyItemTouchUIUtil {

    static final MyItemTouchHelper.MyItemTouchUIUtil INSTANCE =  new ItemTouchUIUtilImpl();
